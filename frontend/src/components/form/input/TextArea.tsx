...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses +=
      ...
      "dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-error-800 ";
  } else {
    textareaClasses +=
      "bg-transparent text-gray-900 border-gray-300 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 " +
